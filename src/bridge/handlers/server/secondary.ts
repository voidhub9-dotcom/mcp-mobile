...
import { resetSecondaryState, secondaryResponseResolvers, setInstanceRole, setRelaySocket, } from "../shared/communication.js";
import type { RobloxResponse } from "../../types.js";
export function startAsSecondary(relayUrl: string = `ws://localhost:${WS_PORT}/mcp-relay`, onFailed?: () => void, onPromote?: () => void): void {
