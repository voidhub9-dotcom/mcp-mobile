...
export default function register(server: McpServer): void {
    server.registerTool("get-console-output", {
        title: "Get the roblox developer console output from the Roblox Game Client",
        description: "Read recent Roblox developer console logs from the active client. Use limit and logsOrder to control volume and ordering.",
    ...
    }, async ({ limit, logsOrder, filter, summaryOnly, maxOutputChars }) => sendAndWait({
