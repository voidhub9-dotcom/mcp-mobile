import { z } from "zod";
import { clientStampPrefix, toolTextResponse } from "../../factory.js";
...
function getLineBlock(lines, lineIndex, contextLines) {
    const block = [];
...
function formatResults(totalMatches, matches, limited, syncNote) {
